...
### Best Practices
  ...
  * You can't connect to Neptune using SSL with this architecture. If you are using a load balancer you must use SSL termination and have your own SSL certificate on the proxy server. SSL passthrough doesn't work because the provided SSL certificates don't match the proxy server hostname. The Network Load Balancer, being a Layer 4 load balancer, doesn't support SSL termination. See [Connecting to Neptune Using SSL](https://docs.aws.amazon.com/neptune/latest/userguide/security-ssl.html) for more details.
...
### Best Practices
  ...
  * You can connect to Neptune via SSL with this architecture. Use SSL termination and have your own SSL certificate on the proxy server. See [Connecting to Neptune Using SSL](https://docs.aws.amazon.com/neptune/latest/userguide/security-ssl.html) for more details.
